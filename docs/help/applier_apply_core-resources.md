## applier apply core-resources

apply core-resources templates located in paths

### Synopsis

apply core-resources templates located in paths with a values.yaml, the list of path can be a path to a file or a directory

```
applier apply core-resources [flags]
```
