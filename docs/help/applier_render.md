...
render templates located in paths

### Synopsis

render templates located in paths with a values.yaml, the list of path can be a path to a file or a directory

```
applier render [flags]
```
