## applier apply custom-resources

apply custom-resources templates located in paths

### Synopsis

apply custom-resources templates located in paths with a values.yaml, the list of path can be a path to a file or a directory

```
applier apply custom-resources [flags]
```
