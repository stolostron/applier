## applier apply deployments

apply deployments templates located in paths

### Synopsis

apply deployments templates located in paths with a values.yaml, the list of path can be a path to a file or a directory

```
applier apply deployments [flags]
```
